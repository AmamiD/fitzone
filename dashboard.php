        ...
        <section class="dashboard-section customer-dashboard two-column-dashboard">
            ...
            <aside class="dashboard-left">
                ...
                <div class="profile-box">
                    <img src="images/profile-icon.png" alt="Profile" class="profile-circle">
                    <h3><?= htmlspecialchars($customer_name); ?></h3>
                    <a href="update_profile.php" class="dashboard-btn update-btn">Update Profile</a>
                ...
                <div class="achievement-section">
                    ...
                    <ul>
                        <li><strong>No</strong> Achievements Yet</li>
            ...
            <div class="dashboard-right">
                ...
                <div class="dashboard-actions top-actions">
                    <a href="book_appointment.php" class="dashboard-btn">Book Appointment</a>
                    <a href="submit_query.php" class="dashboard-btn">Submit Query</a>
                </div>
                ...
                <div class="queries-section">
                    ...
                    if ($res->num_rows > 0) {
                        while ($row = $res->fetch_assoc()) {
                            ...
                            if ($row['response']) {
                                echo "<p class='staff-response'><strong>Staff Response:</strong> {$row['response']}</p>";
                            } else {
                                echo "<p class='awaiting'><em>Awaiting staff response...</em></p>";
                            }
                            echo "<span class='query-date'>Submitted: {$row['submitted_at']}</span>";
                            echo "</div>";
                        }
                    } else {
                        echo "<p class='no-query'>You have not submitted any queries yet.</p>";
                    }
                    ?>
                    </div>
                </div>
