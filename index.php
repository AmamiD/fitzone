...
<section id="about">
    <div class="about-img">
        <img src="images/about.jpg" alt="FitZone Interior">
    </div>
    <div class="about-text">
        <h1>About Us</h1>
        <p>
            At FitZone Fitness Center, we believe that health is a lifestyle. Since our launch, we have committed to delivering a premium fitness experience for everyone.
        </p>
        <p>
...
<section id="contact">
    <div class="contact-text">
        ...
        <?php if (!empty($successMsg)) { echo "<div class='alert success'>$successMsg</div>"; } ?>
        <?php if (!empty($errorMsg)) { echo "<div class='alert error'>$errorMsg</div>"; } ?>
